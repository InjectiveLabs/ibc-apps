...
func (i ICS4Middleware) SendPacket(ctx context.Context, sourcePort string, sourceChannel string, timeoutHeight ibcclienttypes.Height, timeoutTimestamp uint64, data []byte) (sequence uint64, err error) {
...
func (i ICS4Middleware) WriteAcknowledgement(ctx context.Context, packet ibcexported.PacketI, ack ibcexported.Acknowledgement) error {
...
func (i ICS4Middleware) GetAppVersion(ctx context.Context, portID, channelID string) (string, bool) {
